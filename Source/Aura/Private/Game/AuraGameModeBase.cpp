...
UAuraSaveGame* AAuraGameModeBase::RetrieveInGameSavedData()
{
...
void AAuraGameModeBase::SaveWorldState(UWorld* World, const FString& DestinationMapAssetName) const
{
	...
	if (UAuraSaveGame* SaveGame = GetSaveSlotData(AuraGI->LoadSlotName, AuraGI->LoadSlotIndex))
	{
...
void AAuraGameModeBase::LoadWorldState(UWorld* World) const
{
	...
	UAuraSaveGame* SaveGame = GetSaveSlotData(AuraGI->LoadSlotName, AuraGI->LoadSlotIndex);
	if (SaveGame == nullptr)
	{
